import {CamEvent, processEvent, GameState} from './game.js';
import {drawMap, drawCrewmate, drawCrewmates, drawAll} from "./vis.js";


const canvas = <HTMLCanvasElement> document.getElementById("cams-img");
const ctx: CanvasRenderingContext2D = canvas.getContext("2d");
const roomForm = <HTMLFormElement> document.getElementById("room");
const fromForm = <HTMLFormElement> document.getElementById("from");
const toForm = <HTMLFormElement> document.getElementById("to");
const colorForm = <HTMLFormElement> document.getElementById("color");
const saveBtn = <HTMLButtonElement> document.getElementById("save");

const fastInput = <HTMLFormElement> document.getElementById("fast-input");
const fastSubmit = <HTMLButtonElement> document.getElementById("fast-submit");

const eventsListElem = document.getElementById("events-list");

const slider = <HTMLFormElement> document.getElementById("myRange");
let output = document.getElementById("slider-value");


const forms: Array<HTMLFormElement> = [roomForm, fromForm, toForm, colorForm];
...
let eventsList: Array<CamEvent> = [];
let statesList: Array<GameState> = [];


function getFormInfo(): CamEvent {
...
function getFastInfo(): CamEvent {
    let inp: string = fastInput.value;
