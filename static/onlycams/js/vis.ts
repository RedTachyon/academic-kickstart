...
function drawMap(c: HTMLCanvasElement, ctx: CanvasRenderingContext2D, image: HTMLImageElement) {
    ctx.drawImage(image, 0, 0, c.width, c.height);
}

function drawCrewmate(c: HTMLCanvasElement,
...
function drawCrewmates(c: HTMLCanvasElement,
                       ctx: CanvasRenderingContext2D,
                       room: string,
                       colors: Array<string>) {
...
function drawAll(c: HTMLCanvasElement,
                 ctx: CanvasRenderingContext2D,
